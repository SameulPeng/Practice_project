...
public class ShareResult {
    private final int status; // 抢红包标识，1表示抢到红包，0表示抢不到红包，-1表示已经抢到过红包但重复参与
    ...
    private static ShareResult shareFail(String msg, Map<String, Object> result) {
        return new ShareResult(0, msg, result, -1, -1L);
    }
    ...
    private static ShareResult shareRedo(String msg, int share, long timeCost) {
        return new ShareResult(-1, msg, null, share, timeCost);
    }
